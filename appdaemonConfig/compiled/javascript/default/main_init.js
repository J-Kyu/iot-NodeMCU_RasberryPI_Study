$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-header"] = new basedisplay("default-header", "", "default", {'widget_type': 'basedisplay', 'fields': {'title': '', 'title2': 'IoT 2 Contorl Appdaemon', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;text-align: left;vertical-align: top;font-size: 150%;top: 6px;', 'unit_style': '', 'value_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'widget_style': 'background-color: #444;', 'container_style': ''}, 'css': {}, 'icons': [], 'static_icons': [], 'title2_style': 'text-align: left;vertical-align: top;font-size: 150%;color: #fff;top: 6px;', 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'namespace': 'default'})
