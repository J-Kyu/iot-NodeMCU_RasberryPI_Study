$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-clock"] = new baseclock("default-clock", "", "glassic", {'widget_type': 'baseclock', 'fields': {'date': '', 'time': ''}, 'static_css': {'date_style': 'color: #fff;font-weight: 700;font-size: 175%;', 'time_style': 'line-height: 90%;font-weight: bold;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);'}, 'static_icons': [], 'icons': [], 'css': {}, 'namespace': 'default'})
    
        widgets["default-led"] = new baseswitch("default-led", "", "glassic", {'widget_type': 'baseswitch', 'entity': 'switch.led', 'state_active': 'on', 'state_inactive': 'off', 'enable': 1, 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'switch.led'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'switch.led'}, 'fields': {'title': 'LED', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'mdi-led-on', 'icon_off': 'mdi-led-off'}, 'static_icons': [], 'css': {'icon_style_active': 'line-height: 90%;color: #00aaff;', 'icon_style_inactive': 'line-height: 90%;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;'}, 'static_css': {'title_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'title2_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'state_text_style': 'color: white;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);'}, 'icon_on': 'mdi-led-on', 'icon_off': 'mdi-led-off', 'namespace': 'default'})
    
        widgets["default-usb-led"] = new baseswitch("default-usb-led", "", "glassic", {'widget_type': 'baseswitch', 'entity': 'switch.usb_led', 'state_active': 'on', 'state_inactive': 'off', 'enable': 1, 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'switch.usb_led'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'switch.usb_led'}, 'fields': {'title': 'USB LED', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'mdi-alarm-light', 'icon_off': 'mdi-alarm-light-outline'}, 'static_icons': [], 'css': {'icon_style_active': 'line-height: 90%;color: #00aaff;', 'icon_style_inactive': 'line-height: 90%;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;'}, 'static_css': {'title_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'title2_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'state_text_style': 'color: white;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);'}, 'icon_on': 'mdi-alarm-light', 'icon_off': 'mdi-alarm-light-outline', 'namespace': 'default'})
    
        widgets["default-rasbian-display"] = new baseswitch("default-rasbian-display", "", "glassic", {'widget_type': 'baseswitch', 'entity': 'switch.rasbian_display', 'state_active': 'on', 'state_inactive': 'off', 'enable': 1, 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'switch.rasbian_display'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'switch.rasbian_display'}, 'fields': {'title': 'Rasbian Display', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'mdi-monitor', 'icon_off': 'mdi-monitor'}, 'static_icons': [], 'css': {'icon_style_active': 'line-height: 90%;color: #00aaff;', 'icon_style_inactive': 'line-height: 90%;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;'}, 'static_css': {'title_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'title2_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'state_text_style': 'color: white;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);'}, 'icon_on': 'mdi-monitor', 'icon_off': 'mdi-monitor', 'namespace': 'default'})
    
        widgets["default-light-intensity"] = new basedisplay("default-light-intensity", "", "glassic", {'widget_type': 'basedisplay', 'entity': 'sensor.light_intensity', 'entity_to_sub_entity_attribute': '', 'sub_entity': '', 'sub_entity_to_entity_attribute': '', 'fields': {'title': 'Light Intensity', 'title2': '', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'title2_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'state_text_style': 'color: #00aaff;font-size: 100%;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);', 'container_style': ''}, 'css': {'value_style': 'line-height: 90%;font-weight: bold;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'text_style': 'color: #00aaff;font-size: 100%;', 'unit_style': 'color: #00aaff;font-size: 125%;'}, 'icons': [], 'static_icons': [], 'precision': 0, 'namespace': 'default'})
    
        widgets["default-temperature"] = new basedisplay("default-temperature", "", "glassic", {'widget_type': 'basedisplay', 'entity': 'sensor.temperature', 'entity_to_sub_entity_attribute': '', 'sub_entity': '', 'sub_entity_to_entity_attribute': '', 'fields': {'title': 'Temperature', 'title2': '', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'title2_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'state_text_style': 'color: #00aaff;font-size: 100%;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);', 'container_style': ''}, 'css': {'value_style': 'line-height: 90%;font-weight: bold;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'text_style': 'color: #00aaff;font-size: 100%;', 'unit_style': 'color: #00aaff;font-size: 125%;'}, 'icons': [], 'static_icons': [], 'units': '&deg;C', 'precision': 1, 'namespace': 'default'})
    
        widgets["default-humidity"] = new basedisplay("default-humidity", "", "glassic", {'widget_type': 'basedisplay', 'entity': 'sensor.humidity', 'entity_to_sub_entity_attribute': '', 'sub_entity': '', 'sub_entity_to_entity_attribute': '', 'fields': {'title': 'Humidity', 'title2': '', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'title2_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'state_text_style': 'color: #00aaff;font-size: 100%;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);', 'container_style': ''}, 'css': {'value_style': 'line-height: 90%;font-weight: bold;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'text_style': 'color: #00aaff;font-size: 100%;', 'unit_style': 'color: #00aaff;font-size: 125%;'}, 'icons': [], 'static_icons': [], 'units': '%', 'precision': 1, 'namespace': 'default'})
    
        widgets["default-btiphone"] = new basedisplay("default-btiphone", "", "glassic", {'widget_type': 'basedisplay', 'entity': 'sensor.kyu_iphone', 'entity_to_sub_entity_attribute': '', 'sub_entity': '', 'sub_entity_to_entity_attribute': '', 'fields': {'title': 'Kyu iPhone Confidence', 'title2': '', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'title2_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'state_text_style': 'color: #00aaff;font-size: 100%;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);', 'container_style': ''}, 'css': {'value_style': 'line-height: 90%;font-weight: bold;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'text_style': 'color: #00aaff;font-size: 100%;', 'unit_style': 'color: #00aaff;font-size: 125%;'}, 'icons': [], 'static_icons': [], 'units': '%', 'precision': 0, 'namespace': 'default'})
    
        widgets["default-reload"] = new basejavascript("default-reload", "", "glassic", {'widget_type': 'basejavascript', 'command': 'location.reload(true)', 'fields': {'title': '', 'title2': '', 'icon': '', 'icon_style': ''}, 'icons': {'icon_active': 'fas-spinner fa-spin', 'icon_inactive': 'fas-sync'}, 'static_css': {'title_style': 'color: #00aaff;font-weight: bold;', 'title2_style': 'font-weight: bold;color: #899B9A;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);'}, 'css': {'icon_active_style': 'line-height: 90%;color: #00aaff;', 'icon_inactive_style': 'line-height: 90%;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;'}, 'static_icons': [], 'namespace': 'default'})
