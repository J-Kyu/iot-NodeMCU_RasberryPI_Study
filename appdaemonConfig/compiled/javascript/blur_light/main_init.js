$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-header"] = new basedisplay("default-header", "", "blur_light", {'widget_type': 'basedisplay', 'fields': {'title': '', 'title2': 'IoT 2 Contorl Appdaemon', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'color: #fff;font-size: 150%;height: 0px;', 'title2_style': 'color: #fff;font-size: 150%;text-align: left;vertical-align: top;top: 6px;', 'unit_style': '', 'value_style': 'color: #fff;font-size: 150%;', 'state_text_style': '', 'widget_style': 'background-color: transparent;', 'container_style': ''}, 'css': {}, 'icons': [], 'static_icons': [], 'title2_style': 'text-align: left;vertical-align: top;font-size: 150%;color: #fff;top: 6px;', 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'namespace': 'default'})
    
        widgets["default-clock-clock"] = new baseclock("default-clock-clock", "", "blur_light", {'widget_type': 'baseclock', 'fields': {'date': '', 'time': ''}, 'static_css': {'date_style': 'visibility: hidden;height: 0px;', 'time_style': 'color: #fff;font-size: 150%;', 'widget_style': 'background-color: transparent;'}, 'static_icons': [], 'icons': [], 'css': {}, 'entity': 'clock.clock', 'title_is_friendly_name': 1, 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'namespace': 'default'})
    
        widgets["default-led"] = new baseswitch("default-led", "", "blur_light", {'widget_type': 'baseswitch', 'entity': 'switch.led', 'state_active': 'on', 'state_inactive': 'off', 'enable': 1, 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'switch.led'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'switch.led'}, 'fields': {'title': 'LED', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'mdi-led-on', 'icon_off': 'mdi-led-off'}, 'static_icons': [], 'css': {'icon_style_active': 'color: #ffcc00;', 'icon_style_inactive': 'color: antiquewhite;'}, 'static_css': {'title_style': 'color: #646464;font-weight: 400;', 'title2_style': 'color: #646464;font-weight: 400;', 'state_text_style': 'color: #646464;', 'widget_style': 'backdrop-filter: blur(30px);background-color: rgba(255, 255, 255, 0.5);'}, 'icon_on': 'mdi-led-on', 'icon_off': 'mdi-led-off', 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'namespace': 'default'})
    
        widgets["default-usb-led"] = new baseswitch("default-usb-led", "", "blur_light", {'widget_type': 'baseswitch', 'entity': 'switch.usb_led', 'state_active': 'on', 'state_inactive': 'off', 'enable': 1, 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'switch.usb_led'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'switch.usb_led'}, 'fields': {'title': 'USB LED', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'mdi-alarm-light', 'icon_off': 'mdi-alarm-light-outline'}, 'static_icons': [], 'css': {'icon_style_active': 'color: #ffcc00;', 'icon_style_inactive': 'color: antiquewhite;'}, 'static_css': {'title_style': 'color: #646464;font-weight: 400;', 'title2_style': 'color: #646464;font-weight: 400;', 'state_text_style': 'color: #646464;', 'widget_style': 'backdrop-filter: blur(30px);background-color: rgba(255, 255, 255, 0.5);'}, 'icon_on': 'mdi-alarm-light', 'icon_off': 'mdi-alarm-light-outline', 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'namespace': 'default'})
    
        widgets["default-rasbian-display"] = new baseswitch("default-rasbian-display", "", "blur_light", {'widget_type': 'baseswitch', 'entity': 'switch.rasbian_display', 'state_active': 'on', 'state_inactive': 'off', 'enable': 1, 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'switch.rasbian_display'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'switch.rasbian_display'}, 'fields': {'title': 'Rasbian Display', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'mdi-monitor', 'icon_off': 'mdi-monitor'}, 'static_icons': [], 'css': {'icon_style_active': 'color: #ffcc00;', 'icon_style_inactive': 'color: antiquewhite;'}, 'static_css': {'title_style': 'color: #646464;font-weight: 400;', 'title2_style': 'color: #646464;font-weight: 400;', 'state_text_style': 'color: #646464;', 'widget_style': 'backdrop-filter: blur(30px);background-color: rgba(255, 255, 255, 0.5);'}, 'icon_on': 'mdi-monitor', 'icon_off': 'mdi-monitor', 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'namespace': 'default'})
    
        widgets["default-light-intensity"] = new basedisplay("default-light-intensity", "", "blur_light", {'widget_type': 'basedisplay', 'entity': 'sensor.light_intensity', 'entity_to_sub_entity_attribute': '', 'sub_entity': '', 'sub_entity_to_entity_attribute': '', 'fields': {'title': 'Light Intensity', 'title2': '', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'color: #646464;font-weight: 400;', 'title2_style': 'color: #646464;font-weight: 400;', 'state_text_style': '', 'widget_style': 'backdrop-filter: blur(30px);background-color: rgba(255, 255, 255, 0.5);', 'container_style': ''}, 'css': {'value_style': '', 'text_style': 'color: #646464;', 'unit_style': ''}, 'icons': [], 'static_icons': [], 'precision': 0, 'use_comma': 0, 'use_hass_icon': 1, 'namespace': 'default'})
    
        widgets["default-temperature"] = new basedisplay("default-temperature", "", "blur_light", {'widget_type': 'basedisplay', 'entity': 'sensor.temperature', 'entity_to_sub_entity_attribute': '', 'sub_entity': '', 'sub_entity_to_entity_attribute': '', 'fields': {'title': 'Temperature', 'title2': '', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'color: #646464;font-weight: 400;', 'title2_style': 'color: #646464;font-weight: 400;', 'state_text_style': '', 'widget_style': 'backdrop-filter: blur(30px);background-color: rgba(255, 255, 255, 0.5);', 'container_style': ''}, 'css': {'value_style': '', 'text_style': 'color: #646464;', 'unit_style': ''}, 'icons': [], 'static_icons': [], 'units': '&deg;C', 'precision': 1, 'use_comma': 0, 'use_hass_icon': 1, 'namespace': 'default'})
    
        widgets["default-humidity"] = new basedisplay("default-humidity", "", "blur_light", {'widget_type': 'basedisplay', 'entity': 'sensor.humidity', 'entity_to_sub_entity_attribute': '', 'sub_entity': '', 'sub_entity_to_entity_attribute': '', 'fields': {'title': 'Humidity', 'title2': '', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'color: #646464;font-weight: 400;', 'title2_style': 'color: #646464;font-weight: 400;', 'state_text_style': '', 'widget_style': 'backdrop-filter: blur(30px);background-color: rgba(255, 255, 255, 0.5);', 'container_style': ''}, 'css': {'value_style': '', 'text_style': 'color: #646464;', 'unit_style': ''}, 'icons': [], 'static_icons': [], 'units': '%', 'precision': 1, 'use_comma': 0, 'use_hass_icon': 1, 'namespace': 'default'})
    
        widgets["default-btiphone"] = new basedisplay("default-btiphone", "", "blur_light", {'widget_type': 'basedisplay', 'entity': 'sensor.kyu_iphone', 'entity_to_sub_entity_attribute': '', 'sub_entity': '', 'sub_entity_to_entity_attribute': '', 'fields': {'title': 'Kyu iPhone Confidence', 'title2': '', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'color: #646464;font-weight: 400;', 'title2_style': 'color: #646464;font-weight: 400;', 'state_text_style': '', 'widget_style': 'backdrop-filter: blur(30px);background-color: rgba(255, 255, 255, 0.5);', 'container_style': ''}, 'css': {'value_style': '', 'text_style': 'color: #646464;', 'unit_style': ''}, 'icons': [], 'static_icons': [], 'units': '%', 'precision': 0, 'use_comma': 0, 'use_hass_icon': 1, 'namespace': 'default'})
    
        widgets["default-reload"] = new basejavascript("default-reload", "", "blur_light", {'widget_type': 'basejavascript', 'command': 'location.reload(true)', 'fields': {'title': '', 'title2': '', 'icon': '', 'icon_style': ''}, 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-refresh'}, 'static_css': {'title_style': 'color: #646464;font-weight: 400;', 'title2_style': 'color: #646464;font-weight: 400;', 'widget_style': 'backdrop-filter: blur(30px);background-color: rgba(255, 255, 255, 0.5);'}, 'css': {'icon_active_style': 'color: #646464;top: 6px;', 'icon_inactive_style': 'color: #646464;top: 6px;'}, 'static_icons': [], 'icon_active_style': 'top: 6px;', 'icon_inactive_style': 'top: 6px;', 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'namespace': 'default'})
